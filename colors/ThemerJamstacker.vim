if &background == 'dark'
  let s:guishade0 = "#1C1D1F"
  let s:guishade1 = "#3C3D3F"
  let s:guishade2 = "#5D5E5F"
  let s:guishade3 = "#7D7E7F"
  let s:guishade4 = "#9E9E9F"
  let s:guishade5 = "#BEBEBF"
  let s:guishade6 = "#DFDFDF"
  let s:guishade7 = "#FFFFFF"
  let s:guiaccent0 = "#F1729E"
  let s:guiaccent1 = "#A9ABAF"
  let s:guiaccent2 = "#B6795B"
  let s:guiaccent3 = "#DCFF00"
  let s:guiaccent4 = "#5CFFE3"
  let s:guiaccent5 = "#FFFFFF"
  let s:guiaccent6 = "#C490FF"
  let s:guiaccent7 = "#6669B2"
  ...
  let s:ctermaccent0 = 211
  let s:ctermaccent1 = 145
  let s:ctermaccent2 = 174
  let s:ctermaccent3 = 190
  let s:ctermaccent4 = 122
...
highlight clear
syntax reset
let g:colors_name = "ThemerJamstacker"
