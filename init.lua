...
vim.cmd 'colorscheme ThemerJamstacker'

function ColorMyPencils(color)
  color = color or 'ThemerJamstacker'
...
vim.keymap.set('n', '<Esc>', '<cmd>nohlsearch<CR>', { desc = 'Clear search hilights' })
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- Think of <c-f> as moving to the right of your snippet expansion.
